...
function Footer() {
  ...
  const social = [
    {
      link: 'https://www.linkedin.com/in/kashish-garg-94b4472ab/',
      icon: <FaLinkedinIn />,
    },
    {
      link: 'https://github.com/Celebi07',
      icon: <AiFillGithub />,
    },
    {
      link: 'https://twitter.com/Vishi__03',
      icon: <FaXTwitter />,
    },
    {
      link: 'https://www.instagram.com/vishi__03',
      icon: <FaInstagram />,
    }
  ]
    ...
    <footer className='md:flex md:px-10 lg:flex bg-white dark:bg-slate-800 text-black dark:text-white lg:px-48 px-4 py-5 justify-between border-t border-slate-800'>
      ...
      <div className='md:flex lg:flex gap-10 '>
        <div>
          ...
          <a href="mailto:chiragjain.jain7@gmail.com" className='text-[16px]  hover:text-fuchsia-800 transition-all duration-150 ease-in-out cursor-pointer'>Email: kashishgarg89.5@gmail.com</a>
          <p className='text-[16px] pb-5 hover:text-fuchsia-800 transition-all duration-150 ease-in-out'>Phone: +91-8076347880</p>
        </div>
        <div>
